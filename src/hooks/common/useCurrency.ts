...
import { DEFAULT_CHAIN_ID,  DEFAULT_NATIVE_NAME, DEFAULT_NATIVE_SYMBOL, DEFAULT_NATIVE_WRAPPED_ADDRESS  } from '@/constants/default-chain-id'; 
...
export function useCurrency(
    ...
    const isWNative = address?.toLowerCase() === DEFAULT_NATIVE_WRAPPED_ADDRESS.toLowerCase()
